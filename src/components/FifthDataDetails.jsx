...
export default function FifthDataDetails() {
                ...
                <div className="md:flex flex-row">
                  ...
                  <div className="p-7 md:mt-[-40px] md:ml-80">
                    ...
                    <div className="flex flex-col md:flex-row md:gap-0">
                      <div className="md:flex flex-col md:gap-5">
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:ml-[-360px]">
                            Languages:
                          </h3>{" "}
                          <span className="md:text-smaller">
                            {Object.values(fifthData[0].languages)}
                          </span>{" "}
                        </div>
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:text-nowrap md:ml-[-387px]">
                            Sub Region:
                          </h3>
                          <span className="md:text-smaller md:text-nowrap">
                            {fifthData[0].subregion}
                          </span>
                        </div>
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:ml-[-405px]">
                            Top Level Domain:{" "}
                          </h3>
                          <span className="md:text-smaller">
                            {fifthData[0].tld[0]}
                        ...
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 items-center">
                          ...
                          <span className="md:text-smaller md:text-nowrap">
                            {Object.keys(fifthData[0].name.nativeName).map(
                              (code) => (
                                <span key={code}>
                                  {fifthData[0].name.nativeName[code].official}{" "}
                                </span>
                              )
                            )}
                          </span>
                      ...
                      <div className="md:flex flex-col">
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center md:ml-[-250px]">
                          <h3 className="font-bold font-sans text-average md:text-medium">
                            Currencies:
                          </h3>
                          <span className="md:text-smaller">
                            {Object.keys(fifthData[0].currencies).map(
                              (code) => (
                                <span key={code} className="">
                                  {fifthData[0].currencies[code].name}
                                </span>
                              )
                            )}
                          </span>
                        </div>
                        <div className="md:flex flex-row md:justify-center md:items-center md:ml-[-265px] md:mt-[15px]">
                          <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                            <h3 className="font-bold font-sans text-average md:text-medium">
                              Population:{" "}
                            </h3>
                        ...
                        <div className="md:flex flex-row md:justify-center md:items-center md:ml-[-280px] md:mt-[20px]">
                          <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                            <h3 className="font-bold font-sans text-average md:text-medium">
                              Region:{" "}
                            </h3>
                    ...
                    <div className="flex flex-row gap-2 items-center md:text-nowrap md:pt-6">
                      ...
                      {fifthData[0].borders && (
                        <span className="md:text-smaller">
                          {Object.keys(fifthData[0].borders).map((code) => (
                            <span key={code}>
                              {fifthData[0].borders[code] ? (
