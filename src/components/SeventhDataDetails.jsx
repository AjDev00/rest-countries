...
export default function SeventhDataDetails() {
  const { seventhData } = useContext(AppContext);
            ...
            <div className="md:border-transparent md:bg-transparent border border-white bg-white duration-500 shadow-md shadow-slate-200 dark:border-slate-800 dark:shadow-slate-900 rounded-md dark:bg-slate-800 dark:text-white dark:duration-500 md:h-10">
              {seventhData && seventhData[0] && (
                <div className="md:flex flex-row">
                  <div>
                    <img
                      src={seventhData[0].flags.png}
                      alt={seventhData[0].flags.alt}
                  ...
                  <div className="p-7 md:mt-[-40px] md:ml-80">
                    ...
                    <div className="flex flex-col md:flex-row md:gap-0">
                      <div className="md:flex flex-col md:gap-5">
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:ml-[-90px]">
                            Languages:
                          </h3>{" "}
                          <span className="md:text-smaller">
                            {Object.values(seventhData[0].languages)}
                          </span>{" "}
                        </div>
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:text-nowrap md:ml-[-40px]">
                            Sub Region:
                          </h3>
                          <span className="md:text-smaller md:text-nowrap">
                            {seventhData[0].subregion}
                          </span>
                        </div>
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:ml-[-75px]">
                            Top Level Domain:{" "}
                          </h3>
                          <span className="md:text-smaller">
                            {seventhData[0].tld[0]}
                        ...
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 items-center">
                          ...
                          <span className="md:text-smaller md:text-nowrap">
                            {Object.keys(seventhData[0].name.nativeName).map(
                              (code) => (
                                <span key={code}>
                                  {
                                    seventhData[0].name.nativeName[code]
                                      .official
                                  }{" "}
                                </span>
                              )
                      ...
                      <div className="md:flex flex-col">
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center md:ml-[115px]">
                          <h3 className="font-bold font-sans text-average md:text-medium">
                            Currencies:
                          </h3>
                          <span className="md:text-smaller md:text-nowrap">
                            {Object.keys(seventhData[0].currencies).map(
                              (code) => (
                                <span key={code} className="">
                                  {seventhData[0].currencies[code].name}
                                </span>
                              )
                            )}
                          </span>
                        </div>
                        <div className="md:flex flex-row md:justify-center md:items-center md:ml-[110px] md:mt-[15px]">
                          <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                            <h3 className="font-bold font-sans text-average md:text-medium">
                              Population:{" "}
                            </h3>
                            <span className="md:text-smaller">
                              {seventhData[0].population.toLocaleString()}
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="flex flex-row gap-2 items-center md:text-nowrap md:pt-6">
                      ...
                      {seventhData[0].borders && (
                        <span className="md:text-smaller">
                          {Object.keys(seventhData[0].borders).map((code) => (
                            <span key={code}>
                              {seventhData[0].borders[code] ? (
