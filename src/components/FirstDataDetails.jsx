...
export default function FirstDataDetails() {
                ...
                <div className="md:flex flex-row">
                  ...
                  <div className="p-7 md:mt-[-40px] md:ml-80">
                    ...
                    <div className="flex flex-col md:flex-row md:gap-0">
                      <div className="md:flex flex-col md:gap-5">
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:ml-[-120px]">
                            Languages:
                          </h3>{" "}
                          <span className="md:text-smaller">
                            {Object.values(firstData[0].languages)}
                          </span>{" "}
                        </div>
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:text-nowrap md:ml-[-75px]">
                            Sub Region:
                          </h3>
                          <span className="md:text-smaller md:text-nowrap">
                            {firstData[0].subregion}
                          </span>
                        </div>
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:ml-[-100px]">
                            Top Level Domain:{" "}
                          </h3>
                          <span className="md:text-smaller">
                            {firstData[0].tld[0]}
                        ...
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 items-center">
                          ...
                          <span className="md:text-smaller md:text-nowrap">
                            {Object.keys(firstData[0].name.nativeName).map(
                              (code) => (
                                <span key={code}>
                                  {firstData[0].name.nativeName[code].official}{" "}
                                </span>
                              )
                            )}
                          </span>
                      ...
                      <div className="md:flex flex-col">
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center md:ml-[84px]">
                          ...
                          <span className="md:text-smaller">
                            {Object.keys(firstData[0].currencies).map(
                              (code) => (
                                <span key={code} className="">
                                  {firstData[0].currencies[code].name}
                                </span>
                              )
                            )}
                          </span>
                    ...
                    <div className="flex flex-row gap-2 items-center md:text-nowrap md:pt-6">
                      ...
                      {firstData[0].borders && (
                        <span className="md:text-smaller">
                          {Object.keys(firstData[0].borders).map((code) => (
                            <span key={code}>
                              {firstData[0].borders[code] ? (
