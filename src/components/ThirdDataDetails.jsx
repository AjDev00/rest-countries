...
export default function ThirdDataDetails() {
                ...
                <div className="md:flex flex-row">
                  ...
                  <div className="p-7 md:mt-[-40px] md:ml-80">
                    ...
                    <div className="flex flex-col md:flex-row md:gap-0">
                      <div className="md:flex flex-col md:gap-5">
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:ml-[-110px]">
                            Languages:
                          </h3>{" "}
                          <span className="md:text-smaller">
                            {Object.values(thirdData[0].languages)}
                          </span>{" "}
                        </div>
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:text-nowrap md:ml-[-90px]">
                            Sub Region:
                          </h3>
                          <span className="md:text-smaller md:text-nowrap">
                            {thirdData[0].subregion}
                          </span>
                        </div>
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:ml-[-108px]">
                            Top Level Domain:{" "}
                          </h3>
                          <span className="md:text-smaller">
                            {thirdData[0].tld[0]}
                        ...
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 items-center">
                          ...
                          <span className="md:text-smaller md:text-nowrap">
                            {Object.keys(thirdData[0].name.nativeName).map(
                              (code) => (
                                <span key={code}>
                                  {thirdData[0].name.nativeName[code].official}{" "}
                                </span>
                              )
                            )}
                          </span>
                      ...
                      <div className="md:flex flex-col">
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center md:ml-[84px]">
                          ...
                          <span className="md:text-smaller">
                            {Object.keys(thirdData[0].currencies).map(
                              (code) => (
                                <span key={code} className="">
                                  {thirdData[0].currencies[code].name}
                                </span>
                              )
                            )}
                          </span>
                    ...
                    <div className="flex flex-row gap-2 items-center md:text-nowrap md:pt-6">
                      ...
                      {thirdData[0].borders && (
                        <span className="md:text-smaller">
                          {Object.keys(thirdData[0].borders).map((code) => (
                            <span key={code}>
                              {thirdData[0].borders[code] ? (
