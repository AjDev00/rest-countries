...
export default function SeventhData() {
  ...
  return (
    <div>
      <div>
        <div className="px-4 pt-10 w-80 ml-1 md:ml-[-70px] md:px-20">
          {loading ? (
            <p className="font-bold animate-pulse duration-500 font-serif">
              Loading...
            </p>
          ) : (
            <Link to="/seventhdata-details">
