...
export default function SixthDataDetails() {
  const { sixthData } = useContext(AppContext);
            ...
            <div className="md:border-transparent md:bg-transparent border border-white bg-white duration-500 shadow-md shadow-slate-200 dark:border-slate-800 dark:shadow-slate-900 rounded-md dark:bg-slate-800 dark:text-white dark:duration-500 md:h-10">
              {sixthData && sixthData[0] && (
                <div className="md:flex flex-row">
                  <div>
                    <img
                      src={sixthData[0].flags.png}
                      alt={sixthData[0].flags.alt}
                  ...
                  <div className="p-7 md:mt-[-40px] md:ml-80">
                    ...
                    <div className="flex flex-col md:flex-row md:gap-0">
                      <div className="md:flex flex-col md:gap-5">
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:ml-[-118px]">
                            Languages:
                          </h3>{" "}
                          <span className="md:text-smaller">
                            {Object.values(sixthData[0].languages)}
                          </span>{" "}
                        </div>
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                          <h3 className="font-bold font-sans text-average md:text-medium md:text-nowrap md:ml-[-77px]">
                            Sub Region:
                          </h3>
                          <span className="md:text-smaller md:text-nowrap">
                            {sixthData[0].subregion}
                          </span>
                        </div>
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                        ...
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 items-center">
                          ...
                          <span className="md:text-smaller md:text-nowrap">
                            {Object.keys(sixthData[0].name.nativeName).map(
                              (code) => (
                                <span key={code}>
                                  {sixthData[0].name.nativeName[code].official}{" "}
                                </span>
                              )
                            )}
                          </span>
                      ...
                      <div className="md:flex flex-col">
                        <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center md:ml-[110px]">
                          <h3 className="font-bold font-sans text-average md:text-medium">
                            Currencies:
                          </h3>
                          <span className="md:text-smaller">
                            {Object.keys(sixthData[0].currencies).map(
                              (code) => (
                                <span key={code} className="">
                                  {sixthData[0].currencies[code].name}
                                </span>
                              )
                            )}
                          </span>
                        ...
                        <div className="md:flex flex-row md:justify-center md:items-center md:ml-[110px] md:mt-[15px]">
                          <div className="flex flex-row gap-2 mb-4 md:mb-0 md:justify-center md:items-center">
                            ...
                            <span className="md:text-smaller">
                              {sixthData[0].population.toLocaleString()}
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="flex flex-row gap-2 items-center md:text-nowrap md:pt-6">
                      ...
                      {sixthData[0].borders && (
                        <span className="md:text-smaller">
                          {Object.keys(sixthData[0].borders).map((code) => (
                            <span key={code}>
                              {sixthData[0].borders[code] ? (
